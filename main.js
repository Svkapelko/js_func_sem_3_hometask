...
class Manager extends Employee {
    ...
    displayInfo() {
        // super.displayInfo(); // вызывает родительский метод.
...
class Order {
    constructor(orderNumber) {
        ...
        this.products = []; // массив, содержащий список продуктов в заказе
    }
    ...
    checkout() {
        console.log(
            `Заказ ${this.orderNumber} оформлен.Общая стоимость заказа ${this.getTotalPrice()} рублей. Спасибо за покупку!`
        );
    }
}
